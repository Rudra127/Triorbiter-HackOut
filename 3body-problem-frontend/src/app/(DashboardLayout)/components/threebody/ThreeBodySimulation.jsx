...
function ThreeBodySimulation() {
  useEffect(() => {
    ...
    var physics = (function () {
      ...
      function calculateDiameters() {
        ...
        for (var iBody = 0; iBody < initialConditions.bodies; iBody++) {
          if (
            initialConditions.densities !== undefined &&
            initialConditions.densities.length >= initialConditions.bodies - 1
          ) {
    ...
    var graphics = (function () {
      ...
      function clearScene(largestDistanceMeters) {
        ...
        // Update the scaling
        metersPerPixel =
          (2.3 * largestDistanceMeters) /
          Math.min(canvas.offsetWidth, canvas.offsetHeight, window.innerHeight);
      }
    ...
    var simulation = (function () {
      ...
      function animate() {
        ...
        var timestep =
          physics.initialConditions.timeScaleFactor / framesPerSecond / calculationsPerFrame;
    ...
    var simulations = (function () {
      ...
      var allPresets = {
        ...
        Kepler16: {
          masses: [
            0.6897 * 1.98855 * Math.pow(10, 30),
            0.20255 * 1.98855 * Math.pow(10, 30),
            0.3333 * 1.898 * Math.pow(10, 27),
          ],
          massSlider: {
            min: 3 * Math.pow(10, 10),
            max: 3 * Math.pow(10, 31),
    ...
    var userInput = (function () {
      ...
      function didUpdateSlider(sliderValue) {
        ...
        if (sliderSettings.power !== undefined) {
          if (sliderSettings.power % 2 === 1) {
            ...
            sliderValue = oddPowerCurve.sliderOutputValue(
              defaultOutput,
              sliderValue,
              sliderSettings.power,
            );
          } else {
      ...
      function resetSlider() {
        ...
        if (currentSlider === 'mass') {
          sliderText = formatMassForSlider(
            physics.initialConditions.masses[currentMassSliderIndex],
          );
        ...
        sliderLabelElement.innerText = sliderText;
        var sliderPosition =
          (simulationValue - sliderSettings.min) / (sliderSettings.max - sliderSettings.min);

        if (sliderSettings.power !== undefined) {
          if (sliderSettings.power % 2 === 1) {
            // Odd power
            var defaultOutput = calculateDefaultSliderOutput(sliderSettings);
            sliderPosition = oddPowerCurve.sliderInputValue(
              defaultOutput,
              sliderPosition,
              sliderSettings.power,
            );
  ...
  return (
    <>
      <p
        id="ThreeBodyProblem-notSupportedMessage"
        class="ThreeBodyProblem-alert ThreeBodyProblem-isHiddenBlock"
      >
      ...
      <div class="ThreeBodyProblem-container isFullScreenWide isUnselectable">
        <div class="ThreeBodyProblem-sun">
          <img
            src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/sun.png"
            class="ThreeBodyProblem-spin ThreeBodyProblem-bodyImage"
            alt="Sun"
          />
        </div>
        <div class="ThreeBodyProblem-earth">
          <img
            src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/earth.png"
            alt="Earth"
            class="ThreeBodyProblem-spin ThreeBodyProblem-bodyImage"
          />
        </div>
        <div class="ThreeBodyProblem-jupiter">
          <img
            src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/jupiter_juno.png"
            alt="Jupiter"
            class="ThreeBodyProblem-spin ThreeBodyProblem-bodyImage"
          />
        </div>
        <img
          src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/center_of_mass.png"
          alt="Center of mass"
          class="ThreeBodyProblem-centerOfMass"
        />
        ...
        <div class="ThreeBodyProblem-hudContainer">
          <div class="ThreeBodyProblem-hudContainerChild">
            <div class="ThreeBodyProblem-leftBottomButtonCantainer">
              <a
                class="ThreeBodyProblem-leftBottomButton ThreeBodyProblem-mass1Button ThreeBodyProblem-doesChangeOpacityOnHover"
                href="#"
                title="Mass 1"
              >
                <img
                  src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/mass_one_icon.png"
                  alt="Mass 1"
                  class="ThreeBodyProblem-leftBottomImage"
                />
              </a>
              <a
                class="ThreeBodyProblem-leftBottomButton ThreeBodyProblem-mass2Button ThreeBodyProblem-doesChangeOpacityOnHover"
                href="#"
                title="Mass 2"
              >
                <img
                  src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/mass_two_icon.png"
                  alt="Mass 2"
                  class="ThreeBodyProblem-leftBottomImage"
                />
              </a>
              <a
                class="ThreeBodyProblem-leftBottomButton ThreeBodyProblem-mass3Button ThreeBodyProblem-doesChangeOpacityOnHover"
                href="#"
                title="Mass 3"
              >
                <img
                  src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/mass_three_icon.png"
                  alt="Mass 3"
                  class="ThreeBodyProblem-leftBottomImage"
                />
              </a>
              <a
                class="ThreeBodyProblem-leftBottomButton ThreeBodyProblem-speedButton ThreeBodyProblem-doesChangeOpacityOnHover"
                href="#"
                title="Speed"
              >
                <img
                  src="https://evgenii.com/image/blog/2018-09-27-three-body-problem-simulator/clock_icon.png"
                  alt="Speed"
                  class="ThreeBodyProblem-leftBottomImage"
                />
              </a>
            ...
            <a
              class="ThreeBodyProblem-reload ThreeBodyProblem-doesChangeOpacityOnHover"
              href="#"
              title="Reload"
            >
              <img
                src="https://evgenii.com/image/blog/2016-09-17-ridiculous-strawberry-picking/reload_icon.png"
                alt="Restart"
                class="ThreeBodyProblem-reloadIcon"
              />
            </a>
          </div>
        </div>
      ...
      <button class="ThreeBodyProblem-preset ThreeBodyProblem-button" data-name="LagrangePoint5">
        Lagrange point L5
      </button>
      <button class="ThreeBodyProblem-preset ThreeBodyProblem-button" data-name="Kepler16">
        Kepler-16
      </button>
      <button class="ThreeBodyProblem-preset ThreeBodyProblem-button" data-name="Chaotic">
        Chaotic
      </button>
